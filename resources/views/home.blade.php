...
@section('content')
    ...
    <section id="heroSection"
        ...
        <div class="relative z-10 text-center px-4 max-w-3xl mx-auto">
            ...
            <div
                class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded border border-primary-200 dark:border-primary-900 text-primary-600 text-xs font-mono uppercase tracking-wider mb-8 animate-fade-in-up">
            ...
            <!-- Title -->
            <h1
                class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-primary-600 mb-6 animate-fade-in-up delay-100 uppercase">
                Map the Untold
            </h1>

            <!-- Subtitle -->
            <p
                class="text-base sm:text-lg text-slate-500 dark:text-slate-400 mb-12 max-w-xl mx-auto animate-fade-in-up delay-200 leading-relaxed font-light font-sans">
                Enter any global location to extract a highly structured intelligence report including historical timelines,
                local insights, and geographical analysis.
            </p>
            ...
            <div class="animate-fade-in-up delay-300 space-y-6">
                ...
                <div class="flex items-center gap-4 max-w-xs mx-auto">
                    ...
                    <span class="text-slate-400 dark:text-slate-600 text-xs font-mono uppercase tracking-wider">or
                        query</span>
                    <div class="flex-1 h-px bg-slate-200 dark:bg-slate-800"></div>
                </div>
    ...
    <section id="loadingSection" class="hidden py-24 px-4 bg-slate-50 dark:bg-slate-950">
        <div class="max-w-4xl mx-auto text-center">
            <!-- Spinner -->
            <div
                class="w-12 h-12 border-2 border-slate-300 dark:border-slate-700 border-t-primary-600 dark:border-t-primary-500 rounded-full animate-spin mx-auto mb-8">
            </div>

            <!-- Loading Message -->
            <h2 class="text-xl font-bold uppercase tracking-wider text-slate-900 dark:text-white mb-2" id="loadingTitle">
                Analyzing Coordinates...</h2>
            <p class="text-sm font-mono text-slate-500 dark:text-slate-400" id="loadingMessage">Generating target data
                stream</p>
    ...
    <section id="reportSection"
        class="hidden pb-24 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800">
        <!-- Dashboard Header -->
        <div class="border-b border-slate-200 dark:border-slate-800 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-6">
                <div>
                    <p class="text-xs font-mono uppercase tracking-widest text-primary-600 mb-2" id="reportBadge">PlacePulse
                        Intelligence Dossier</p>
                    <h1 class="text-3xl sm:text-4xl font-bold text-primary-600 tracking-tight uppercase" id="reportTitle">
                    </h1>
                    <p class="text-md text-slate-500 dark:text-slate-400 font-light mt-2 max-w-2xl" id="reportSubtitle"></p>
                </div>
                <div
                    class="flex items-center gap-2 border border-primary-200 dark:border-primary-900/40 rounded bg-primary-50/20 dark:bg-primary-950/20 px-3 py-1.5 text-xs font-mono text-primary-600">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 space-y-8">
            ...
            <div id="reportSoul"
                class="report-section bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 sm:p-10 shadow-sm">
                <div class="flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-800/60 pb-4">
                    <svg class="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="prose prose-slate dark:prose-invert max-w-none text-base leading-relaxed font-light text-slate-600 dark:text-slate-300 space-y-4"
                    id="soulContent"></div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div id="reportHistory"
                    class="report-section delay-200 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm h-full">
                    <div class="flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-800/60 pb-4">
                        <svg class="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <h2 class="text-xs font-mono uppercase tracking-wider text-primary-600">Chronological Milestones
                        </h2>
                    </div>
                    <div class="space-y-6 relative border-l border-slate-200 dark:border-slate-800 pl-4 ml-2 animate-fade-in-up"
                        id="historyContent"></div>
                </div>

                <!-- Must Visit Spots -->
                <div id="reportMustVisit"
                    class="report-section delay-300 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm h-full">
                    <div class="flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-800/60 pb-4">
                        <svg class="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M9 6.75V15m6-6v8m-3-12.5A2.25 2.25 0 1 1 9.75 3h4.5A2.25 2.25 0 1 1 12 5.25Z" />
                        </svg>
                        <h2 class="text-xs font-mono uppercase tracking-wider text-primary-600">Curated Points of Interest
                        </h2>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                <!-- Local Flavors -->
                <div id="reportFlavors"
                    class="report-section delay-400 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm h-full">
                    <div class="flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-800/60 pb-4">
                        <svg class="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <h2 class="text-xs font-mono uppercase tracking-wider text-primary-600">Cultural & Flavor Profiles
                        </h2>
                    </div>
                ...
                <!-- Practical Tips -->
                <div id="reportTips"
                    class="report-section delay-500 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm h-full">
                    <div class="flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-800/60 pb-4">
                        <svg class="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div id="reportFacts"
                class="report-section delay-600 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-sm">
                <div class="flex items-center gap-2 mb-6 border-b border-slate-100 dark:border-slate-800/60 pb-4">
                    <svg class="w-4 h-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <!-- ═══════════════ FOOTER ═══════════════ -->
    <footer
        class="py-10 px-3 text-center text-xs font-mono uppercase tracking-wider text-slate-400 dark:text-slate-600 border-t border-slate-200/60 dark:border-slate-800/60 bg-white dark:bg-slate-950">
